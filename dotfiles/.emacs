...
;; requires sr-speedbar, powerline and the solarized-dark theme.

( cond
  (( string-match "linux" system-configuration )
    ( message "Linux detected." )
      ;; Any special settings for linux goes here.
    )
  ((string-match "nt4" system-configuration)
    ( message "Windows detected.")
      ;; Any special settings for windows goes here.
      ;; Emacs home definition - set only if Windows.
